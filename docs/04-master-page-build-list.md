...
| `svc-hydro-jetting` | Service | `/services/hydro-jetting/` | Transactional service | svc-hydro-jetting | — | — | complete | published | indexable | needs-revision (metadata only) | needs-collection | pass (PENDING-018 endpoint gap applies site-wide) | pass | keep-indexable | Medium | Shares site-wide fallback meta/OG/Twitter description (Finding H2) | Author unique meta/OG/Twitter description |
